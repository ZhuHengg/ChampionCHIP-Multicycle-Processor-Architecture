// =============================================================================
// Module: alu_out_reg
// Description: ALU Output Pipeline Register. Latches the live ALU result and
//              provides both the full 32-bit alu_out bus and the 2-bit addr_lsb
//              tap directly to the Control Unit (eliminating the need for a
//              separate bus splitter).
// =============================================================================
