// =============================================================================
// Module: ir_splitter
// Description: Instruction Register Field Splitter for ChipInventor.
//              Splits the 32-bit instruction into RISC-V fields.
// =============================================================================

module ir_splitter (
    input  wire [31:0] instr_i,      // 32-bit instruction from fetch_registers.ir_o
