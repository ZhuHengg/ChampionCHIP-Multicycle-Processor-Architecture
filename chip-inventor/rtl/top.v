// top.v -- structural top level for the ChampionCHIP multicycle core.
//
// Submodules live one-per-file in rtl/; they are NOT inlined here. OpenLane
// builds this design with VERILOG_FILES=dir::rtl/*.v, so duplicating the
// submodule bodies in this file made every module doubly-declared and
// synthesis failed before it began. Keep this file to the top module only.
...
module top (
  ...
  // guide/team-fixed interface. ChipInventor's canvas compiler rejects
  // hierarchical dot-refs into instance internals, so testbench.v cannot
  // read pc/regfile contents any other way.
...
//Internal Wires
 ...
 wire w_71;
 wire [3:0] w_72;
 // Derived enable outputs from control_unit (were left unconnected by the
 // canvas export, and both consuming registers were hardwired to en_i=1'b1).
 wire w_not_adr_src;
 wire w_result_src_is_mem;

//Interface Assigns
assign pc_dbg_o = w_2[31:0];
...
control_unit_eq26 blk3567_46 (
         ...
         .oe_o (w_71),
         .bw_o (w_72),
         .not_adr_src_o (w_not_adr_src),
         .result_src_is_mem_o (w_result_src_is_mem)
     );
