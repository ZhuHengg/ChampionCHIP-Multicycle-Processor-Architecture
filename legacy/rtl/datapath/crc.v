// crc.v — CRC-16/CCITT-FALSE over 8/16/32 bits (Xicrc). a_i=data, b_i=seed.
...
module crc (
    ...
    parameter INIT    = 16'hFFFF; // unused directly, seed comes in via b_i
